...
// normalized event to data/events.jsonl.
//
...
const EVENTS_FILE = 'E:/Projects/Caisson/data/events.jsonl';
const STOP_MARKER = 'E:/Projects/Caisson/data/stop-markers.txt';
const DEBUG_FILE  = 'E:/Projects/Caisson/data/hook-debug.jsonl';
const TASKS_FILE  = 'E:/Projects/Caisson/data/tasks.json';
