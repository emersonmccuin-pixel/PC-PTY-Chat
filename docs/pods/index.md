...
| Agents/pods/catalog/MCP | `auditing` | Codex | `PC-PTY-Chat-phase5` / `codex/phase-5-hardening` | `docs/pods/agents-pods-catalog-mcp.md` | Pod records, stock pods, MCP tools, catalog, allowlists. |
