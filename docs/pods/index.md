...
| Desktop/dev controls | `complete` | Codex | `PC-PTY-Chat-phase5` / `codex/phase-5-hardening` | `docs/pods/desktop-dev-controls.md` | Source audit and cleanup slice recorded. No restart, reload, package, or dogfood smoke run. |
